...
namespace ARTech.Server.Data.Migrations
{
    ...
    [Migration("20220205135606_AddedDefaultDataAndUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARTech.Server.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ARTech.Shared.Domain.Customer", b =>
                {
            ...
            modelBuilder.Entity("ARTech.Shared.Domain.Logistic", b =>
                {
            ...
            modelBuilder.Entity("ARTech.Shared.Domain.Staff", b =>
                {
                    b.Property<int>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ARTech.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasOne("ARTech.Shared.Domain.Logistic", "Logistic")
                        .WithMany()
                        .HasForeignKey("LogisticId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ARTech.Shared.Domain.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ARTech.Server.Models.ApplicationUser", null)
                        .WithMany()
